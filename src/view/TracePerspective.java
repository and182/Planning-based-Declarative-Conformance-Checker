...
public class TracePerspective extends JPanel{
	...
	private void initComponent() {
		...
		this.setBorder(new TitledBorder(null, "STEP 2: Create traces of tasks taken from the repository", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		
		//
		// JLabels on top of the JFrame
		//
		firstBoxLabel = new JLabel("Repository of tasks");
		firstBoxLabel.setPreferredSize(new Dimension(295,15));		

		secondBoxLabel  = new JLabel("Tasks in the Trace");
		secondBoxLabel.setPreferredSize(new Dimension(220,15));
		...
		alphabetScrollPane.setPreferredSize(new Dimension(200,90));
		...
		addTaskButtonPanel.setPreferredSize(new Dimension(90,110)); 
		...
		tracesComboBox.setPreferredSize(new Dimension(85,25)); 
		tracesComboBox.addItem(" --- ");
		
		editTraceButton = new JLinkButton();
		editTraceButton.setText("Add/Del");
		editTraceButton.setPreferredSize(new Dimension(90,15)); 
		...
		traceScrollPane.setPreferredSize(new Dimension(170,90));
		...
		moveTasksInTheTraceButtonPanel.setPreferredSize(new Dimension(45,100)); 
