...
public class AlphabetPerspective extends JPanel{
	...
	private void initComponent() {
		...
		this.setBorder(new TitledBorder(null, "STEP 1: Create a repository of tasks", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		
		//
		// JLabels on top of the JFrame
		//
		firstBoxLabel = new JLabel("Create a new task");
		firstBoxLabel.setPreferredSize(new Dimension(295,15));		

		secondBoxLabel = new JLabel("Repository of tasks");
		...
		alphabetScrollPane.setPreferredSize(new Dimension(220,90));
		...
		this.setPreferredSize(new Dimension(540,190));
